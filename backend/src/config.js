...
const namePrefix = "DriftQueensNFT";
const description = "This is Drift Queens! Drift Queens is a art based collection of 7,500 anime girls who love to drift! Our goal with this project is to spread positivity!";
